...
target_angle_log = np.zeros((t_0, len(target)))
...
utils.plot_neuron_activity_ba_mt(activity_log,ring,bump_log,target_angle_log)
...
live_plot.plot_hi_live_mt(h_i_log, ring,target_angle_log,bump_log)